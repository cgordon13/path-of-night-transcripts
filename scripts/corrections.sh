...
find . -type f -name "*.txt" -exec sed -i'' -e 's/gang world/Gangrel/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/gangler/Gangrel/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/gangrol/Gangrel/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/gangril/Gangrel/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/gangball/Gangrel/g' {} +
...
find . -type f -name "*.txt" -exec sed -i'' -e 's/ reece/ Reiss/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/ Reese/ Reiss/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/ reese/ Reiss/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/astonite/Assamite/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/just a car/Justicar/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/Roland'\''s/Rowlands/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/roland'\''s/Rowlands/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/Marcus vital/Marcus Vitel/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/Marcus Vitale/Marcus Vitel/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/Marcus Vital/Marcus Vitel/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/set tight/Setite/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/asomite/Assamite/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/toria door/Toreador/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/Kelis/Khalis/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/gangra/Gangrel/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/Center Shawl/Seneschal/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/Center Shaw/Seneschal/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/center shawl/Seneschal/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/center shaw/Seneschal/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/center Shaw/Seneschal/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/Center shaw/Seneschal/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/Santa Shawn/Seneschal/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/Center show/Seneschal/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/center show/Seneschal/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/Rebecca segalfest/Rebecca Steigelfest/g' {} +
...
find . -type f -name "*.txt" -exec sed -i'' -e 's/erica webb/Erika Webb/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/Rebecca staglefest/Rebecca Steigelfest/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/Rob mirrorhead/Rob Muirhead/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/solarity/Celerity/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/Solarity/Celerity/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/ vikos/ Vykos/g' {} +
...
find . -type f -name "*.txt" -exec sed -i'' -e 's/Rebecca steglefest/Rebecca Steigelfest/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/Sea Dog/C-Dog/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/ venture/ Ventrue/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/ Venture/ Ventrue/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/British/Britta/g' {} +
find . -type f -name "*.txt" -exec sed -i'' -e 's/british/Britta/g' {} +
